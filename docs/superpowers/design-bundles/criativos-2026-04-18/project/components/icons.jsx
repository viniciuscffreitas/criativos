...
const Icon = ({ d, size = 16, stroke = 'currentColor', sw = 1.5, fill = 'none', children }) => (
...
const IconCanvas = (p) => <Icon {...p}><circle cx="6" cy="6" r="2.5"/><circle cx="18" cy="18" r="2.5"/><circle cx="18" cy="6" r="2.5"/><path d="M8.5 6H15.5M7.8 7.8l8.4 8.4"/></Icon>;
const IconBrand = (p) => <Icon {...p}><path d="M12 2l2.39 6.95H21l-5.3 4.29L17.78 20 12 15.77 6.22 20l2.08-6.76L3 8.95h6.61z"/></Icon>;
...
const IconText = (p) => <Icon {...p}><path d="M4 7V5h16v2M9 5v14M15 19H9"/></Icon>;
const IconLayers = (p) => <Icon {...p}><path d="M12 2l10 6-10 6L2 8z"/><path d="M2 16l10 6 10-6M2 12l10 6 10-6"/></Icon>;
const IconWand = (p) => <Icon {...p}><path d="M15 4V2M15 16v-2M8 9h2M20 9h2M17.8 11.8L19 13M17.8 6.2L19 5M3 21l9-9M12.2 6.2L11 5"/></Icon>;
const IconDownload = (p) => <Icon {...p}><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"/></Icon>;
const IconCopy = (p) => <Icon {...p}><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></Icon>;
const IconHeart = (p) => <Icon {...p}><path d="M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 10-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 000-7.8z"/></Icon>;
...
const IconZap = (p) => <Icon {...p}><path d="M13 2L3 14h9l-1 8 10-12h-9z"/></Icon>;
...
const IconUpload = (p) => <Icon {...p}><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M17 8l-5-5-5 5M12 3v12"/></Icon>;
...
const IconRefresh = (p) => <Icon {...p}><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></Icon>;
const IconHeart2 = IconHeart;

Object.assign(window, {
  Icon, IconSparkle, IconGrid, IconCanvas, IconBrand, IconSettings, IconPlus,
  IconSearch, IconPlay, IconPause, IconImage, IconVideo, IconText, IconLayers,
  IconWand, IconDownload, IconCopy, IconHeart, IconCheck, IconArrowRight,
  IconClose, IconCommand, IconMore, IconZap, IconTarget, IconUsers, IconUpload,
  IconChevronDown, IconChevronRight, IconDot, IconRefresh,
});
