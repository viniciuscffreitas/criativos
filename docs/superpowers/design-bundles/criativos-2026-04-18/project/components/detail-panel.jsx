...
function DetailPanel({ creative, onClose }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {['Preview', 'Copy', 'Metadata'].map((t, i) => (
          <div key={t} style={{
            ...
            borderBottom: i === 0 ? '2px solid oklch(0.65 0.18 25)' : '2px solid transparent',
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '20px 16px' }}>
        ...
        <Section title="Desempenho previsto">
        ...
        <Section title="Metadata">
          ...
          <MetaRow k="Duração" v={creative.duration || '—'}/>
        </Section>
      </div>
...
function PredRow({ label, value, trend }) {
...
function FeedImagePreview({ creative }) {
  return (
    <div style={{ flex: 1, padding: '6px 8px', fontSize: 10 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
        ...
        <div>
          <div style={{ fontWeight: 600, color: '#1c1917' }}>urbanrun.oficial</div>
          <div style={{ color: '#6f6a64', fontSize: 10 }}>Patrocinado</div>
        </div>
      </div>
      <div style={{
        aspectRatio: '1', background: creative.bg,
...
function ReelsPreview({ creative }) {
  return (
    <div style={{
      flex: 1, background: creative.bg, position: 'relative',
      display: 'flex', flexDirection: 'column', justifyContent: 'flex-end',
      padding: 10,
    }}>
      {/* Play badge */}
      ...
      <div style={{ color: '#fff', fontSize: 10 }}>
        <div style={{ fontWeight: 600, marginBottom: 2 }}>@urbanrun.oficial</div>
      ...
      {/* Right actions */}
      <div style={{
        position: 'absolute', right: 6, bottom: 40,
...
function CarouselPreview({ creative }) {
  return (
      ...
      <div style={{ display: 'flex', gap: 4, overflow: 'hidden' }}>
        {[0,1,2].map(i => (
          <div key={i} style={{
            ...
            aspectRatio: '1',
            background: [creative.bg, 'linear-gradient(135deg, #1c1917, #44403c)', 'linear-gradient(135deg, oklch(0.65 0.18 25), oklch(0.5 0.18 25))'][i],
...
Object.assign(window, { DetailPanel, MiniPhone });
